<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffRegistration.aspx.cs" Inherits="WebApp.StaffPages.StaffRegistration" %>
    ...
    <div id="body">
        ...
        <fieldset>
            ...
            <li>
                ...
                <asp:Label ID="LabelRole" runat="server" AssociatedControlID="Role1">Role</asp:Label>
                <asp:DropDownList ID="Role1" runat="server" CssClass="dropd">
                    <asp:ListItem></asp:ListItem>
                    <asp:ListItem>Staff</asp:ListItem>
                    <asp:ListItem>Admin</asp:ListItem>
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Role1" CssClass="field-validation-error" ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
            </li>
            <li>
