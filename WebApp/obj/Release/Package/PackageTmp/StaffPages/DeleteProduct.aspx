<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteProduct.aspx.cs" Inherits="WebApp.StaffPages.DeleteProduct" %>
    ...
    <div id="body">
        <section class="content-wrapper main-content clear-fix">
            ...
            <div style="padding:30px; background:#f8f8f8">
                ...
                <h3>Delete Product from Catalog:</h3>
                <table>
                    <tr>
                    <td><b>Product Name: </b> </td>
                    <td><asp:TextBox ID="delNameBox" runat="server"></asp:TextBox></td>
                        
                    </tr>
                    <tr>
                <td><b>Quantity: </b></td>
                <td><asp:TextBox ID="delQuantBox" runat="server"></asp:TextBox></td>
                </tr>
                    </table>
                <p><asp:Button ID="delProdButton" runat="server" Text="Delete Product" OnClick="delProdButton_Click" /><asp:Button ID="CatalogButton" runat="server" OnClick="CatalogButton_Click" Text="Display Products" /></p>
                <p><asp:Label ID="delError" runat="server"></asp:Label></p>
                <p><asp:Label ID="delProductOutput" runat="server"></asp:Label></p>
